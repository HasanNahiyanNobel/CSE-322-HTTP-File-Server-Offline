...
public class ServerWorker extends Thread {
	...
	public ServerWorker (Socket socket, int port, String rootDirectoryPath, BufferedReader bufferedReader, PrintWriter printWriter, DataInputStream dataInputStream, DataOutputStream dataOutputStream) {
		this.socket = socket;
		this.port = port;
